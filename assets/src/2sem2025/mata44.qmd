...
[Cronograma](https://docs.google.com/spreadsheets/d/13YdqfN1X6jfqwSwO1mpokTNaV5LDasL57Hq2cvEF6As/edit?usp=sharing){target="_blank"}

## Slides

[Primeiro dia de aula](primeiro-dia-mata44.pdf){target="_blank"}<br>
...
[Pasta no `google drive` com planilhas google - apenas leitura.](https://drive.google.com/drive/folders/1f5eYvSWZLXj4mxFWKQP3C61H2qljh19m?usp=sharing){target="_blank"}.
...
[Número de faltas por matrícula](https://docs.google.com/spreadsheets/d/1dzWb7a4S2ciBR6eWe2Ot_s0ViTQd7ZTY5R4vXf3SXJc/edit?usp=sharing){target="_blank"} -->

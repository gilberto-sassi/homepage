...
[Introdução à linguagem `R`](linguagem-r.pdf)
...
[Aula do dia 14/09/2023](https://docs.google.com/spreadsheets/d/1Kpa5sFp0350MPFVsbrVYCfLRyq1ZT1fo3so5biFuizQ/edit?usp=sharing){target="_blank"}

### `codeshare.io`

[Aula de terça-feira](https://codeshare.io/mpwBxb){target="_blank"}<br>
[Aula de segunda e quarta](https://codeshare.io/DZON3r){target="_blank"}
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/Q8Twlxp8kMs?si=l7OcnmEKXwjqwZoX" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>

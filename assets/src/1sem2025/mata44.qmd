...
Pontuação as pessoas que assistiram pelo menos 32400 segundos (75% das três aulas).

Essa contagem foi feita usando o _log_ da plataforma _Big Blue Button_. Tentei associar os nomes e matrículas com as informações no SIAC. Isso foi feito parcialmente manual. Quem tiver dúvida, me procure no telegram.
